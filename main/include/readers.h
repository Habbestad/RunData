...
// Almost every line in a .tcx file starts with some whitespace followed by "<xyz>". headerMatch() checks if a string (line) is of this form and
// if header == "xyz". 
...
std::string getData(std::ifstream& infile, 
